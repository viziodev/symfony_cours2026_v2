 ...
 */
final class Version20251101153439 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE employe ADD photo VARCHAR(255) DEFAULT NULL, CHANGE id id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE employe DROP photo, CHANGE id id INT AUTO_INCREMENT NOT NULL');
    }
}
